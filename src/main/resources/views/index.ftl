...
<#--                </div>-->
           ...
           <div class="tip">
            ...
            <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
                ...
                <button class="login-btn" type="button" lay-submit="" onclick="javascript:window.location.href=ctx+'/toRegister'">注册</button>
            </div>
        </form>
...
<div class="footer">
    项目管理子系统XM04项目组<span class="padding-5">|</span>Copyright@2019XM04 All Rights Reserved
</div>

<script src="${ctx.contextPath}/public/js/index.js" charset="utf-8"></script>
</body>
</html>